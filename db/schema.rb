...
ActiveRecord::Schema.define(version: 20_181_013_093_425) do
  ...
  create_table 'fae_files', id: :serial, force: :cascade do |t|
    ...
    t.index %w[fileable_type fileable_id], name: 'index_fae_files_on_fileable_type_and_fileable_id'
  end
  ...
  create_table 'fae_images', id: :serial, force: :cascade do |t|
    ...
    t.index %w[imageable_type imageable_id], name: 'index_fae_images_on_imageable_type_and_imageable_id'
  end
  ...
  create_table 'fae_text_fields', id: :serial, force: :cascade do |t|
    ...
    t.index %w[contentable_type contentable_id], name: 'index_fae_text_fields_on_contentable_type_and_contentable_id'
